...
<div class="container gx-3 gy-2 align-items-center">
    <div class="row  ">
         {{-- <div class="col-md-16">  --}}
           <h3>Зарлагдсан дадлага</h3>
            <table class="shadow-lg p-3 mb-5 bg-body-tertiary rounded table "> <br>
                ...
                @endforeach
                </tbody><a href="{{route('alljobs')}}" class="dropdown-item" style="text-align:right" >Бүгдийг харах
                <img src="{{URL('avatar/iconback.png')}}" alt="">
                </a>
            </table>
        </div>
