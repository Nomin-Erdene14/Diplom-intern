          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Админ нэмэх</h6>
              </div>
            </div>
            <div class="container">
                         ...
                         <form action="{{Route('admin.admin.store')}}" method="POST"> @csrf
                            ...
                            <div class="col-md-6"> 
                                <div class="form-floating">
                                    <input type="text" class="form-control border px-2" id="name" @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="Нэр оруулна уу">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="email" class="form-control border px-2" id="email" @error('email') is-invalid @enderror name="email" value="{{ old('email') }}" required autocomplete="email">
                            ...
                            <div class="col-12"> <br>
                                <div class="form-floating rounded border">
                                    <input id="password" type="password" @error('password') is-invalid @enderror" name="password" required autocomplete="new-password"class="form-control px-2" id="dob" placeholder="Subject"@error('dob') is-invalid @enderror" name="dob" value="{{ old('dob') }}" required autocomplete="dob" autofocus>
