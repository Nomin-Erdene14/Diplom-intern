          ...
          <div class="">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Сонголтыг засах</h6>
              </div>
            </div>
            <div class="container">
  ...
  <div class="card-body">
        <form method="POST" action="{{ route('admin.options.update', $option->id) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="question_id">{{ trans('Сонголтыг засах асуултыг сонгоно уу') }}</label>
            ...
            <div class="form-group">
                <label class="required" for="option_text">{{ trans('Сонголтыг засах') }}</label>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('points') ? 'is-invalid' : '' }}" type="number" name="points" id="points" value="{{ old('points', $option->points) }}" step="1">
