                ...
                <div class="col-md-16">
                   <div class="card">
                    <div class="card-header">
                        <h4>Хэрэглэгч нэмэх
                            <a href="{{route('admin.user.view')}}" class="btn btn-primary btn-sm text-white float-end">Буцах</a>
                        </h4>
                    </div>
                     <div class="card-body">
                         <form action="{{Route('admin.user.store')}}" method="POST"> @csrf
                            ...
                            {{-- <div class="col-md-12"> <br>
                                <div class=" rounded border">
                                    <label class="form-label">{{ __('Хэргэлэгчийн төрөлийг оруулна уу') }}</label>
                                    <div class="form-group">
                                        <select name="user_type"  class="form-control">
                                            <option value="">--Сонго--</option>
                                            <option value="simple_user">Хэрэглэгч</option>
                                            <option value="employer">Дадлага зарлагч</option>
